...
@section('content')
    ...
    <form class="form" action="edit_profile" method="post"  enctype="multipart/form-data">
        ...
        <div class="container" >
            <div class="card">
                <div class="card-header text-lg-center"><b> Update Your Profile Details</b>
                    <label class=" text-danger">( You must have to fill '*' marking field )</label>
                </div>
                <br>
                ...
                <div class="card" style="width: 80%; margin-left: 10% ">
                    ...
                    <div class="well well-md">
                        <div class="card-body  form-group" style="width: 80%; margin-left: 10% ">
                            ...
                            <input type="text" class="form-control" value="" name="ancestralfamilyorigin" >
                            <br>

                            <label for="">Mother's Occupation</label>
                            <input type="text" class="form-control" value="" name="motheroccupation" >
                            <br>

                            <label for="">Father's Occupation</label>
                            <input type="text" class="form-control" value="" name="fatheroccupation" >
                            <br>

                            <label for="">No. of Brother</label>
                            <input type="number" class="form-control" value="" name="noofbrother" >
                            <br>

                            <label for="">No. of Married Brother</label>
                            <input type="number" class="form-control" value="" name="noofmarriedbrother" >
                            <br>

                            <label for="">No. of Sister</label>
                            <input type="number" class="form-control" value="" name="noofsister" >
                            <br>

                            <label for="">No. of Married Sister</label>
                            <input type="number" class="form-control" value="" name="noofmarriedsister" >
                            <br>
                ...
                <div class="card" style="width: 80%; margin-left: 10% ">
                    ...
                    <div class="well well-md">
                        <div class="card-body  form-group" style="width: 80%; margin-left: 10% ">
                            ...
                            <input type="text" class="form-control" value="" name="spokenlanguage" ><br>
                            ...
                            <input type="text" class="form-control" value="" name="hobbies" ><br>

                            <label for="">Favourites</label>
                            <input type="text" class="form-control" value="" name="favourite" ><br>
                ...
                <div><button type="submit" class="btn btn-primary btn" >Save  </button></div>
